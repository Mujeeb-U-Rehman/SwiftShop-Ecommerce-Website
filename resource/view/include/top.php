...
<html lang="en">
	<head>
		...
		<meta name="author" content="Mujeeb U Rehman , Faizan Ali">
		<title> SwiftShop | <?php echo $pageTitle ?> </title>
		
		<link rel="icon" type="image/icon" href="public/assets/images/favicon/Frontendlogo.png">
				...
				<div class="header-top">
					<div class="container">
						<div class="header-left header-dropdowns">
							...
							<div class="header-dropdown">
								<a href="#"><img src="public/assets/images/favicon/pk.png" alt="Pakistan flag">Pakistan</a>
								<div class="header-menu">
									<ul>
					...
					<div class="container">
						<div class="header-left">
							<a href="index.php" class="logo">
								<img style="height: 60px;" src="public/assets/images/favicon/Frontendlog.png" alt="SwiftShop Logo">
							</a>
						</div>
						...
						<div class="header-right">
							...
							<div class="header-contact"><span>Call us now</span>
								<a href="tel:#"><strong>+923313214836</strong></a>
							</div>
