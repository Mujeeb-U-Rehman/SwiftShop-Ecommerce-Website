							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										<li><span class="contact-info-label">Address:</span>GIKI,TOPI Pakistan</li>
										<li><span class="contact-info-label">Phone:</span>Toll Free <a href="tel:">+923313214836</a></li>
										<li><span class="contact-info-label">Email:</span> <a href="mailto:mail@example.com">Mujeeb@gmail.com</a></li>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | Developed By 
							<a href="#" target="_blank"> Mujeeb U Rehman, Faizan ALi</a>
						</p>
