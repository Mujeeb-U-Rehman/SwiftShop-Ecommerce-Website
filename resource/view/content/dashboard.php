					...
					<div class="panel">
						<div class="panel-body">
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="mailto:mrburero@gmail.com"> 
									<i class="fa fa-envelope"></i> &nbsp; mrburero@gmail.com
								</a>
							</div>
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="callto:+923313214836" style="margin-right: 8px;"> 
									<i class="fa fa-phone"></i> &nbsp; +92 3313214836
								</a>
								<a class="btn p-follow-btn" href="skype:live:.cid.5ed7daebee5e7820"> 
									<i class="fa fa-skype"></i> &nbsp; Mujeeb
								</a>
							</div>
						</div>
					</div>
