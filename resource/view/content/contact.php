			...
			<script type="text/javascript">
				...
				function init() {
					...
					var mapOptions = {
						...
						center: new google.maps.LatLng(34.0691, 72.6441), // GIKI
				...
				var marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(34.0691, 72.6441)});infowindow = new google.maps.InfoWindow({content:"GHULAM ISHAQ KHAN INSTITUTE" });google.maps.event.addListener(marker, "click", function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);
			</script> 
			...
			<div class="col-md-4">
				...
				<div class="contact-info">
					...
					<div>
						...
						<p><a href="mailto:#">mrburero@gmail.com</a></p>
						<p><a href="mailto:#">mrburero@gmail.com</a></p>
					</div>
					<div>
						<i class="icon-skype"></i>
						<p><a href="skype:live:.cid.5ed7daebee5e7820">Mujeeb</a></p>
